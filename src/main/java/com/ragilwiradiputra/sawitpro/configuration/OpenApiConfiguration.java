...
@Configuration
@OpenAPIDefinition(
    info = @Info(title = "Sawit Pro API", version = "v1",
        contact = @Contact(name = "Ragil Wiradiputra", email = "ragilwira@gmail.com", url = "https://ragilwiradiputra.com"),
        license = @License(name = "Apache 2.0", url = "https://www.apache.org/licenses/LICENSE-2.0"),
        description = "Sawit Pro Technical Test"),
    servers = {
